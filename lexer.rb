class Lexer 
  ...
  def tokenize(code)
    ...
    # Current indentation level is the number of spaces in the last indent
    current_indent = 0
    ...
    while i < code.size
      ...
      if identifier = chunk[/\A([a-z]\w*)/, 1]
        # Keywords are special identifiers tagged with their own name, 'if' will result in 
        # an [:IF, "if"] token
      ...
      #   line 1
      #   line 2   # 2) new line inside of a block
      # continue   # 3) dedent

      # This elsif takes care of the first case. The number of spaces will determine the 
      # indent level.
      ...
      # Case 2: we stay in the same block of the indent level (number of spaces is the 
